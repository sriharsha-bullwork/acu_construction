...
def generate_launch_description():
  ...
  host_arg = DeclareLaunchArgument(
    "host", default_value=TextSubstitution(text="caster.emlid.com")
  )
  port_arg = DeclareLaunchArgument(
    "port", default_value=TextSubstitution(text="2101")
  )
  mountpoint_arg = DeclareLaunchArgument(
    "mountpoint", default_value=TextSubstitution(text="MP23489")
  )
  username_arg = DeclareLaunchArgument(
    "username", default_value=EnvironmentVariable(name="NTRIP_USERNAME", default_value="u94435")
  )
  password_arg = DeclareLaunchArgument(
    "password", default_value=EnvironmentVariable(name="NTRIP_PASSWORD", default_value="656kqp")
  )
