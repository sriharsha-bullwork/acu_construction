...
def generate_launch_description():
  ...
  params_base= [
            ...
            {'CFG_MSGOUT_RTCM_3X_TYPE1077_UART2': 0x1},
            {'CFG_MSGOUT_RTCM_3X_TYPE1084_UART2': 0x1},
            {'CFG_MSGOUT_RTCM_3X_TYPE1087_UART2': 0x1},
            {'CFG_MSGOUT_RTCM_3X_TYPE1094_UART2': 0x1},
            {'CFG_MSGOUT_RTCM_3X_TYPE1097_UART2': 0x1},
            {'CFG_MSGOUT_RTCM_3X_TYPE1124_UART2': 0x1},
            {'CFG_MSGOUT_RTCM_3X_TYPE1127_UART2': 0x1},
  ...
  container_navsatfix = ComposableNodeContainer(
    name='ublox_nav_sat_fix_hp_container_base',
    namespace='',
    package='rclcpp_components',
    executable='component_container_mt',
    arguments=['--ros-args', '--log-level', LaunchConfiguration('log_level')],
